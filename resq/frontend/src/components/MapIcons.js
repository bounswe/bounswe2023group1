...
export const AnnotationIcon = ({icon, color}) =>
    ({
        fire: <LocalFireDepartment style={{pointerEvents: "auto"}}/>,
        health: <LocalHospital style={{pointerEvents: "auto", color: color || "#e00000"}}/>,
        closed: <Cancel style={{pointerEvents: "auto"}}/>
    })[icon]
