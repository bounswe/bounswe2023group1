...
public class NotificationMessages {
    public static final String REQUEST_CREATED_WITH_NEED = "Need #%s is included by %s in the Request #%s";
    ...
    public static final String TASK_UNASSIGNED = "Coordinator %s unassigned Task #%s";
}
