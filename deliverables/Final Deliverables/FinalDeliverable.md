...
| Muhammet Ali Topcu | We started to the development of the project via reviewing our design documents from the previous lecture, CMPE352. Then, we created teams and I was a member of the backend team. In the team, I assigned tasks to create initial structures of the database design, initial project structure, dockerization of the both resq service and annotation services, and also deployment of them to the EC2 servers. Besides, I also assigned other tasks such as designing the Categorization tree, implementing Authentication/Authorization, enabling HTTPS security, and other API developments. In addition, for the services that I coded, I also wrote unit tests to ensure that every unit of service works as expected. Lastly, I updated some parts of the project according to frontend/mobile requests and fixed some bugs that are reported by them |
| Furkan Bülbül | As a part of a backend team, we revised the UML diagrams to plan the database design and classes. I attend the customer meeting to have more insigth on what we were supposed to develop. We build the backend from the basic entites to composite entites. I had active role to build the flow of a user can have in our application. Task assignment, resource-request matching are the couple of key points of the application is implemented for. Some of the endpoints I created, some were refactored. I helped the client teams to solve their problems they were having with the endpoints. I tried to solve some bugs they encountered and followed an implementation method they advised.|
| Kübra Aksu | I contributed significantly to the Disaster Response Platform, focusing on frontend development and project coordination. My key tasks included: Developing intuitive Sign-In and Sign-Up pages with user-friendly interfaces. Creating a User Role page and an "Account for Profile" section for enhanced personalization. By Milestone 2, I advanced to complex tasks like developing specialized map pages for responders and facilitators, along with an efficient data table for request and action management. This phase marked substantial improvements in functionality and user experience. By Milestone 3, I expanded my focus to backend integration, emphasizing security and privacy. I created role-specific functionalities, including customized map pages and a comprehensive action management table for coordinators, significantly improving operational efficiency and user interaction. Throughout the project, my role extended beyond development to include debugging, documentation, design, and project management. I actively collaborated with backend and mobile teams, ensuring platform consistency. I was instrumental in drafting user scenarios, testing mechanisms, presenting progress, and preparing comprehensive reports. Regularly revising project requirements, I maintained alignment with evolving project goals and customer feedback. My contributions were pivotal in both the technical advancements and strategic direction of the platform. |
...
- [Ilgaz Er](https://github.com/bounswe/bounswe2023group1/wiki/Ilgaz-Er-CMPE-451-Final-Milestone-Individual-Contribution-Report)
- [Kübra Aksu](https://github.com/bounswe/bounswe2023group1/wiki/K%C3%BCbra-Aksu-Individual-Contribution-Report-%E2%80%90-Final-Milestone)
